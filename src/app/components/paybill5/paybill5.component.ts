...
@Component({
  selector: 'app-paybill5',
  templateUrl: './paybill5.component.html',
  styleUrls: ['./paybill5.component.scss']
})
export class Paybill5Component {
  ...
  userIds: any[] = [5]; // Array to store user ids
  usertampil: any = {};
  userNames: any[] = [];
