...
@Component({
  selector: 'app-paybill3',
  templateUrl: './paybill3.component.html',
  styleUrls: ['./paybill3.component.scss']
})
export class Paybill3Component {
  ...
  userIds: any[] = [3]; // Array to store user ids
  usertampil: any = {};
  userNames: any[] = [];
