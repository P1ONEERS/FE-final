...
@Component({
  selector: 'app-paybill1',
  templateUrl: './paybill1.component.html',
  styleUrls: ['./paybill1.component.scss']
})
export class Paybill1Component {
  ...
  userIds: any[] = [1]; // Array to store user ids
  usertampil: any = {};
  userNames: any[] = [];
