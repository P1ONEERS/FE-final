...
@Component({
  selector: 'app-paybill2',
  templateUrl: './paybill2.component.html',
  styleUrls: ['./paybill2.component.scss']
})
export class Paybill2Component {
  ...
  userIds: any[] = [2]; // Array to store user ids
  usertampil: any = {};
  userNames: any[] = [];
